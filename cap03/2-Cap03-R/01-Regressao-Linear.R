...
setwd("~/Documents/BA/cap03/2-Cap03-R")
getwd()
...
# Corrplot
# Como as variaveis estão correlacionadas
?cor
m_cor <- cor(mtcars)
?corrplot
...
# com a analise do grafico -> mostra que os carros manuais tem uma autonomia maior no consumo.
