...
#ppois(q = 4, lambda = 3) # -> formas erradas
#ppois(q = 4, lambda = 3, lower.tail = TRUE)
#ppois(q = 4, lambda = 3, lower.tail = FALSE)
ppois(q = 4, lambda = 3, lower.tail = TRUE) - ppois(q = 1, lambda = 3, lower.tail = TRUE) # -> correta

# Vamos plotar todas as possibilidades
x <- ppois(q = 0:10, lambda = 3,  lower.tail = TRUE)
barplot(x, names.arg = 0:10, space = 0)

# Qual a probabilidade de qualquer número de vendas em uma semana se a taxa média de vendas
# for de 3 por semana?
